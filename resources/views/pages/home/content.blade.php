                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="icon icon-box-success ">
                            <span class="fa-solid fa-brain icon-item"></span>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="icon icon-box-success">
                            <span class="fa-solid fa-chart-line icon-item"></span>
                        </div>
                    </div>
                </div>
                <h6 class="text-muted font-weight-normal">Experience</h6>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="icon icon-box-success">
                            <span class="fa-solid fa-award icon-item"></span>
                        </div>
                    </div>
                </div>
                <h6 class="text-muted font-weight-normal">Awards</h6>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="icon icon-box-success ">
                            <span class="fa-solid fa-globe icon-item"></span>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <canvas id="transaction-history" class="transaction-chart mt-4"></canvas>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-row justify-content-between">
                    <h4 class="card-title mb-1">Fawwaz Github Repository</h4>
                    <p class="text-muted mb-1">Last Updated</p>
                </div>
                <div class="row">
                    <div class="col-12">
                        @foreach ($datarepos as $key => $data)
                                ...
                                <div class="preview-item border-bottom">
                                    ...
                                    <div class="preview-item-content d-sm-flex flex-grow">
                                        <div class="flex-grow">
                                            ...
                                            <p class="text-muted mb-0">{{ $data->language }}</p>
                                        </div>
                                        <div class="me-auto text-sm-right pt-2 pt-sm-0">
                                            <p class="text-muted">{{ date('Y-m-d H:i:s',strtotime($data->updated_at)) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
